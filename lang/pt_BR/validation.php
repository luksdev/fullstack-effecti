...
return [
    ...
    | pela classe validadora. Algumas regras possuem múltiplas versões, como
    | as regras de tamanho. Sinta-se livre para ajustar cada mensagem aqui.
    |
    */
